...
const _limit = JSON.parse(fs.readFileSync('./funções de cmd/grupos/limit.json'))
const afk = JSON.parse(fs.readFileSync('./funções de cmd/grupos/afk.json'))
const dindin = JSON.parse(fs.readFileSync('./funções de cmd/usuarios/dindin.json'));
